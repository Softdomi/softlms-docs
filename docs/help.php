...
<head>
    ...
    <title><?php echo $translations['help']; ?> - SoftLMS</title>
...
<?php include 'sidebar.php'; ?>
 ...
 <div class="lg:w-3/4 <?php echo $current_lang == 'ar ' ? 'lg:pr-8 ' : 'lg:pl-8 '; ?>">
  ...
  <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['help']; ?></h1>
     <p class="text-gray-600 mt-2"><?php echo $translations['help_subtitle']; ?></p>
 </div>

    <div>

<div class="border-b pb-4 mb-6">
  <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['way1']; ?></h1>
     <p class="text-gray-600 mt-2"><?php echo $translations['way1_subtitle']; ?></p>
 </div>
<!--help---------------------------------- -->
 <div class="  mb-16   <?php echo $current_lang == 'ar ' ? ' rtl' : ' ltr'; ?>">
    ...
    <?php
$imageSrc = $current_lang === 'ar' ? 'way1-contact-ar.png' : 'way1-contact-en.png';
?>

<div class="img object-fit-cover">
    <img src="../assets/images/docs-imgs/<?= $imageSrc ?>" alt="way1 us" class="w-full">
</div>
       ...
       <div class=" flex mb-2">
         <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_lang == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
             ...
             <div class="ms-2">
                <h3 class="font-semibold text-secondary"><?php echo $translations['way1_desc1']; ?></h3>
...
<div class="border-b pb-4 mb-6">
  <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['way2']; ?></h1>
     <p class="text-gray-600 mt-2"><?php echo $translations['way2_subtitle']; ?></p>
 </div>
<!--help---------------------------------- -->
 <div class="  mb-16   <?php echo $current_lang == 'ar ' ? ' rtl' : ' ltr'; ?>">
    ...
    <?php
$imageSrc = $current_lang === 'ar' ? 'way2-contact-ar.png' : 'way2-contact-en.png';
?>

<div class="img object-fit-cover">
    <img src="../assets/images/docs-imgs/<?= $imageSrc ?>" alt="way2 us" class="w-full">
</div>
       <div class="content p-6 border border-xl rounded-md border-s-4 border-s-primary shadow mt-6 mb-12">
       <h2 class = " flex gap-2 font-bold font-medium text-md mb-4 "> <span>
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
       ...
       <div class=" flex mb-2">
         <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_lang == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
             ...
             <div class="ms-2">
                <h3 class="font-semibold text-secondary"><?php echo $translations['way2_desc1']; ?></h3>
