...
<head>
    ...
    <title><?php echo $translations['manage_profile']; ?> - SoftLMS</title>
...
<div class="border-b pb-4 mb-6">
  <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['manage_profile']; ?></h1>
     <p class="text-gray-600 mt-2"><?php echo $translations['manage_profile_subtitle']; ?></p>
 </div>
<!--manage profile---------------------------------- -->
 <div class="  mb-16   <?php echo $current_lang == 'ar ' ? ' rtl' : ' ltr'; ?>">


    <div class="manage-profile mb-16 ">
       
    <?php
$imageSrc = $current_lang === 'ar' ? 'manage-profile-ar.png' : 'manage-profile-en.png';
?>
       ...
       <div class=" flex mb-2">
         <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_lang == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
             ...
             <div class="ms-2">
                <h3 class="font-semibold text-secondary"><?php echo $translations['manage_profile_desc1']; ?></h3>
