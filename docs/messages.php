...
<div class="border-b pb-4 mb-6">
  <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['admin_msg']; ?></h1>
     <p class="text-gray-600 mt-2"><?php echo $translations['admin_msg_subtitle']; ?></p>
 </div>
<!--messages---------------------------------- -->
 <div class="  mb-16   <?php echo $current_lang == 'ar ' ? ' rtl' : ' ltr'; ?>">
    ...
    <?php
$imageSrc = $current_lang === 'ar' ? 'message-ar.png' : 'message-en.png';
?>
       ...
       <div class=" flex mb-2">
         <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_lang == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
             ...
             <div class="ms-2">
                <h3 class="font-semibold text-secondary"><?php echo $translations['admin_msg_desc1']; ?></h3>
