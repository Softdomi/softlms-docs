...
<head>
    ...
    <title><?php echo $translations['admin_dashboard']; ?> - SoftLMS</title>
...
<?php include 'sidebar.php'; ?>
 ...
 <div class="lg:w-3/4 <?php echo $current_lang == 'ar ' ? 'lg:pr-8 ' : 'lg:pl-8 '; ?>">
    ...
    <div class="border-b pb-4 mb-6">
     <h1 class="text-2xl font-bold text-secondary"><?php echo $translations['admin_dashboard']; ?></h1>
        <p class="text-gray-600 mt-2"><?php echo $translations['admin_dashboard_subtitle']; ?></p>
    </div>
    <div class="sales-report mb-16 ">
       
    <?php

$imageSrc = $current_lang === 'ar' ? 'admin-panel-ar.png' : 'admin-panel-en.png';
?>

<div class="img object-fit-cover">
    <img src="../assets/images/docs-imgs/<?= $imageSrc ?>" alt="admin dashboard" class="w-full">
</div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
       ...
       </span><span> <?php echo $translations['attention']; ?> </span> 
     </h2>
       <div class=" flex mb-2">
        <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_data_center == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
            ...
            <div class="ms-2">
               <h3 class="font-semibold text-secondary"><?php echo $translations['admin_dashboard_desc1']; ?></h3>
        ...
        <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_data_center == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
            ...
            <div class="ms-2">
               <h3 class="font-semibold text-secondary"><?php echo $translations['admin_dashboard_desc2']; ?></h3>
        ...
        <div class="flex-shrink-0  flex items-center justify-center text-white font-bold"> <svg class="h-5 w-6 text-primary flex-shrink-0 <?php echo $current_data_center == 'ar' ? '' : ''; ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="5" d="M5 13l4 4L19 7" />
            ...
            <div class="ms-2">
               <h3 class="font-semibold text-secondary"><?php echo $translations['admin_dashboard_desc3']; ?></h3>
